...
## 0. 词簇分配（2026-08-04 定版）

竞争验证结论：Manim 词簇（manim web editor 等）由 manim.community 与多家专业竞品重兵把守；
"math animation" 外圈词簇（math animation maker / ai math animations / math animation maker
