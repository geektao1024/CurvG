export const meta = {
  ...
  description: 'The terms and conditions for using CurvG.',
...
CurvG provides a mathematical curve gallery and may provide tools for AI-assisted scene planning, code generation, and animation rendering. Features may change as the product develops. We may modify, suspend, or discontinue any part of the service at any time, with reasonable notice where possible.
